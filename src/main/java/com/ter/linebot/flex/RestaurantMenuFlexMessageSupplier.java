...
public class RestaurantMenuFlexMessageSupplier implements Supplier<FlexMessage> {
    ...
    private Box createMenusBox() {
        final Box menu1 = Box.builder()
                ...
                .contents(asList(
                        Icon.builder()
                                .url(URI.create("https://raw.githubusercontent.com/iphayao/line-bot-spring-boot-flex/master/src/main/resources/img/regular.png")).build(),
        ...
        final Box menu2 = Box.builder()
                ...
                .contents(asList(
                        Icon.builder()
                                .url(URI.create("https://raw.githubusercontent.com/iphayao/line-bot-spring-boot-flex/master/src/main/resources/img/large.png")).build(),
    ...
    private Box createFooterBox() {
        ...
        final Button button = Button.builder()
                ...
                .color("#905c44")
                .action(new URIAction("Add to Cart", URI.create("http://example.com"),null))
                .build();
        return Box.builder()
                .layout(FlexLayout.VERTICAL)
