...
public class NewsFlexMessageSupplier implements Supplier<FlexMessage> {
    ...
    private Box createThumbnailsBox() {
        final Image imagesContent1 = Image.builder()
                .url(URI.create("https://raw.githubusercontent.com/iphayao/line-bot-spring-boot-flex/master/src/main/resources/img/thumbnail1.png"))
                .aspectMode(Image.ImageAspectMode.Cover)
        ...
        final Image imagesContent2 = Image.builder()
                .url(URI.create("https://raw.githubusercontent.com/iphayao/line-bot-spring-boot-flex/master/src/main/resources/img/thumbnail2.png"))
                .aspectMode(Image.ImageAspectMode.Cover)
                .aspectRatio(Image.ImageAspectRatio.R4TO3)
                .size(Image.ImageSize.SM)
    ...
    private Box createFooterBlock() {
        return Box.builder()
                ...
                .contents(asList(
                        Button.builder()
                                .action(new URIAction("more", URI.create("https://example.com"),null))
                                .build()
                )).build();
    }
}
