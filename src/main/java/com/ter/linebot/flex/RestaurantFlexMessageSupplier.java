...
public class RestaurantFlexMessageSupplier implements Supplier<FlexMessage> {
    ...
    private Image createHeroBlock() {
        return Image.builder()
                .url(URI.create("https://raw.githubusercontent.com/iphayao/line-bot-spring-boot-flex/master/src/main/resources/img/cafe.png"))
    ...
    private Box createFooterBlock() {
        ...
        final Button callAction = Button.builder()
                ...
                .action(new URIAction("CALL", URI.create("tel:00000"),null))
                .build();
