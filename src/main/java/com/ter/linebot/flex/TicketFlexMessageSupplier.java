...
public class TicketFlexMessageSupplier implements Supplier<FlexMessage> {
    ...
    private Image createHeroBlock() {
        return Image.builder()
                .url(URI.create("https://raw.githubusercontent.com/iphayao/line-bot-spring-boot-flex/master/src/main/resources/img/movie.png"))
    ...
    private Box createPreviewBox() {
        final Icon goldStart = Icon.builder()
                ...
                .url(URI.create("https://raw.githubusercontent.com/iphayao/line-bot-spring-boot-flex/master/src/main/resources/img/gold_star.png"))
                .build();
        final Icon grayStart = Icon.builder()
                .size(FlexFontSize.SM)
                .url(URI.create("https://raw.githubusercontent.com/iphayao/line-bot-spring-boot-flex/master/src/main/resources/img/gray_star.png"))
                .build();
    ...
    private Box createQRCodeBox() {
        ...
        final Image qrImage = Image.builder()
                .url(URI.create("https://raw.githubusercontent.com/iphayao/line-bot-spring-boot-flex/master/src/main/resources/img/qrcode.png"))
                .aspectMode(Image.ImageAspectMode.Cover)
